#We're going to do some text processing to convert the CSV to something more readable.

#Here's the string description on Kaggle:
s = '''1- Student Age (1: 18-21, 2: 22-25, 3: above 26)
